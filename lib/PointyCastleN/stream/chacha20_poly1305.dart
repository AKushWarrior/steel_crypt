...
import 'package:steel_crypt/PointyCastleN/src/impl/base_aead_cipher.dart';
...
class ChaCha20Poly1305 extends BaseAEADCipher {
  ...
  @override
  String get algorithmName => 'ChaCha20Poly1305';
  ...
  void finishData(int nextState) {
    ...
    pack64(_aadCount, lengths, 0, Endian.little);
    pack64(_dataCount, lengths, 8, Endian.little);
